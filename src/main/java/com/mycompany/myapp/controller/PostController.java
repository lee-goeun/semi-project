...
//	public ModelAndView listPosts(HttpServletRequest request, HttpServletResponse response, PostVO vo) throws Exception;
	...
	// 포스트상세조회
	public ModelAndView viewPost(@RequestParam("postId") int postId, HttpServletRequest request,
			HttpServletResponse response) throws Exception;

	// 포스트 수정페이지로 진입
	public ModelAndView viewPost1(@RequestParam("postId") int postId, HttpServletRequest request,
			HttpServletResponse response) throws Exception;
