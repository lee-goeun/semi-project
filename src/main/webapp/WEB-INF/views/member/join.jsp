...
<form id="join_form" method="post">
	...
	<div>&nbsp;</div>
		...
		<div class="id_input_box">
			...
			<span class="id_check">필수 정보입니다.</span>
...
<input class="form-control"  placeholder="우편번호" name="postCode" id="addr1" type="text" readonly="readonly" >
    <button type="button" class="btn btn-default" onclick="execPostCode();" id="post"><i class="fa fa-search"></i> 우편번호 찾기</button>                               
</div>
<div class="form-group">
	...
	<tr class="mobileNo">
		...
		<td>
			<p>
				...
				<input type="button" id="phoneChk" class="doubleChk" value="인증번호 보내기"/><br/>
				<input id="phone2" type="text" name="phone2" title="인증번호 입력" disabled required/>
					 <!-- <span id="phoneChk2" class="doubleChk">본인인증</span> -->
					 <input type="button" id="phoneChk2" class="doubleChk"value="본인인증"/>
				
					<br/><span class="point successPhoneChk">휴대폰 번호 입력후 인증번호 보내기를 해주세요</span>
...
//비밀번호 길이 확인
$('.pw_fir_input').on("propertychange change keyup paste input", function(){
